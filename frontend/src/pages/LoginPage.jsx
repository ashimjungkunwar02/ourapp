        ...
        <div className="bg-[#111111] border border-gray-800 rounded-2xl p-8
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-green-400 font-black text-3xl">SWEEPS</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#1a1a1a] border border-gray-700 rounded-xl
                             px-4 py-3 text-white placeholder-gray-600 outline-none
                             pr-12 focus:border-green-500 focus:ring-1
                             focus:ring-green-500/30 transition-all duration-200"
                />
                <button
                  type="button"
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="bg-red-500/10 border border-red-500/30 rounded-xl
                           px-4 py-3 text-red-400 text-sm text-center"
              >
                {error}
              </motion.div>
            )}
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-400
                         disabled:bg-green-800 text-black font-bold py-3.5
            ...
            >
              {loading ? (
                <div className="w-5 h-5 border-2 border-black/30 border-t-black
